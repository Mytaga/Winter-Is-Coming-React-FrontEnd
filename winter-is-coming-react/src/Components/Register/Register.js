        ...
        <div className={styles['wrapper']}>
            <div className={styles['formContent']}>
                ...
                <form>
                    ...
                    <input type="text" id="login" className={styles['fadeIn-sixth']} name="register" placeholder="FirstName" />
                    <input type="text" id="login" className={styles['fadeIn-seventh']} name="register" placeholder="LastName" />
