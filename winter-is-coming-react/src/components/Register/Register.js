        ...
        <div className={styles['wrapper']}>
            <div className={styles['formContent']}>
                ...
                <form>
                    ...
                    <input type="text" id="login" className={styles['fadeIn-sixth']} name="register" placeholder="First Name" />
                    <input type="text" id="login" className={styles['fadeIn-seventh']} name="register" placeholder="Last Name" />
                    <input type="text" id="login" className={styles['fadeIn-eight']} name="register" placeholder="Username" />
